...
# current day.
$action = New-ScheduledTaskAction -Execute $PowerShellPath -Argument "-NoProfile -WindowStyle Hidden -ExecutionPolicy Bypass -File `"$Runner`" -NodePath `"$NodePath`"" -WorkingDirectory $ProjectRoot
